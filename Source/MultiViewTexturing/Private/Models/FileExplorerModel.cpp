...
void mvt::FileExplorerModel::SetCurrentDrive(const std::string& letter)
{
...
rxcpp::observable<std::string> mvt::FileExplorerModel::CurrentDirectoryFlowOut()
{
...
rxcpp::observable<FileExplorerModel::dir_entry_array> mvt::FileExplorerModel::CurrentDirEntriesFlowOut()
{
...
rxcpp::observable<unsigned int> mvt::FileExplorerModel::DriveCountFlowOut()
{
...
rxcpp::observable<FileExplorerModel::drive_letter_array> mvt::FileExplorerModel::DriveLettersFlowOut()
{
	return m_Impl->DriveLettersFlowOutSubj.get_observable().as_dynamic();
}
rxcpp::observable<FileExplorerModel::dir_entry_array> mvt::FileExplorerModel::CurrentDirHierarchyFlowOut()
{
