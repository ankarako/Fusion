#ifndef	__OPTIXRAYTRACER_PUBLIC_UTILS_QUATERNION_H__
#define __OPTIXRAYTRACER_PUBLIC_UTILS_QUATERNION_H__
...
#endif	///	!__OPTIXRAYTRACER_PUBLIC_UTILS_QUATERNION_H__