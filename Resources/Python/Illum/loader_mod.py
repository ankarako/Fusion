...
class IlluminationModule(nn.Module):
	def __init__(self, batch_size):
		super().__init__()
		self.cv_block1 = conv_bn_elu(3, 64, kernel_size=7, stride=2) # 160 x 120 - #128x256  
		self.cv_block2 = conv_bn_elu(64, 128, kernel_size=5, stride=2) # 80 x 60 - #64x128
		self.cv_block3 = conv_bn_elu(128, 256, stride=2) # 40 x 30  #32x64
		self.cv_block4 = conv_bn_elu(256, 256)
		self.cv_block5 = conv_bn_elu(256, 256, stride=2)  # 20 x 15 #16x32
		self.cv_block6= conv_bn_elu(256, 256)
		self.cv_block7 = conv_bn_elu(256, 256, stride=2) # 10 x 8 # 8x16
